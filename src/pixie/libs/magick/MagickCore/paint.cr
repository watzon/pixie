lib LibMagick
  ...
  fun transparentPaintImage = TransparentPaintImage(image : Image*, target : PixelInfo*, opacity : LibC::Float, invert : Bool, exception : ExceptionInfo*) : Bool
  fun transparentPaintImageChroma = TransparentPaintImageChroma(image : Image*, low : PixelInfo*, high : PixelInfo*, opacity : LibC::Float, invert : Bool, exception : ExceptionInfo*) : Bool
end
